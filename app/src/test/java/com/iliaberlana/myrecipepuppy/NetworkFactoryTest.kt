...
class RecipeDataSourceTest {
    ...
    private lateinit var recipeClient : RecipeClientTest
    ...
    fun setUp() {
        ...
        recipeClient = networkFactory.createApi(RecipeClientTest::class.java, httpUrl.toString())
    }
